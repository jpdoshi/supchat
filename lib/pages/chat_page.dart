                      ...
                      child: PopupMenuButton(
                        ...
                        itemBuilder: (context) => [
                          PopupMenuItem(
                            ...
                            child: Row(
                              children: [
                                Icon(Icons.attachment_outlined, size: 22, color: Theme.of(context).colorScheme.primary),
                          ...
                          PopupMenuItem(
                            ...
                            child: Row(
                              children: [
                                Icon(Icons.perm_media_outlined, size: 22, color: Theme.of(context).colorScheme.primary),
                                const SizedBox(width: 12),
                          ...
                          PopupMenuItem(
                            ...
                            child: Row(
                              children: [
                                Icon(Icons.music_note_outlined, size: 22, color: Theme.of(context).colorScheme.primary),
                                const SizedBox(width: 12),
