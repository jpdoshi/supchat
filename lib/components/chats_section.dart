...
class _ChatSectionState extends State<ChatSection> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        searchBar(context, widget.showSearchBar),
        filterButtons(context, setState),
        chatsList(),
      ],
    );
  }
...
AnimatedContainer searchBar(context, showSearchBar) {
  return AnimatedContainer(
    height: showSearchBar ? 62 : 0,
...
Container filterButtons(context, setState) {
  return Container(
    color: Theme.of(context).colorScheme.surface,
